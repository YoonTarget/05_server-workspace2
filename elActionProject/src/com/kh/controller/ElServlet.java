...
public class ElServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 
		 * 위의 4개의 객체들에
		 * 데이터를 담을 때는 .setAttribute("키값", 담고자 하는 데이터(벨류값))
		 * 데이터를 꺼낼 때는 .getAttribute("키값") : 담겨있는 데이터(벨류값)
		 * 데이터를 삭제할 때는 .removeAttribute("키값")
		 */
		...
		session.setAttribute("teacher", new Person("윤관현", 29, "남자"));
