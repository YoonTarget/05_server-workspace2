...
<body>
	...
	<p>
		...
		* 동기식 / 비동기식 <br>
		...
		<ul>
			...
			<li>서버에 요청한 결과까지의 시간이 지연되면 무작정 기다려야됨 (흰 페이지로 보여질거임)</li>
		...
		* 비동기식의 단점 <br>
		...
		- 에러 발생시 디버깅 어려움 <br>
		- 요청 처리 후에 돌아온 응답데이터를 가지고 현재 페이지에 새로운 요소를 만들어서 뿌려줘야될거임 => dom 요소들을 새로이 만들어내는 구문을 잘 익혀둬야됨
		<br><br>
	...
	* 부수적인 속성
	...
	<h3>2. 버튼 클릭시 post 방식으로 서버에 요러개의 데이터 전송 및 응답</h3>
		...
		function test3() {
			...
			$.ajax({
				...
				success:function(result){
					...
					const value = "<br>이름 : " + result.userName + "<br>"
								+ "나이 : " + result.age + "<br>"
								+ "성별 : " + result.gender;
