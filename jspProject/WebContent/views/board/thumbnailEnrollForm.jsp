        ...
        <form action="<%= contextPath %>/insert.th" id="enroll-form" method="post" enctype="multipart/form-data">
            ...
            <table align="center">
                ...
                <tr>
                    <th>내용</th>
                    <td colspan="3">
                        <textarea name="content" cols="22" rows="5" style="resize: none;" required></textarea>
                    </td>
                </tr>
                <tr>
                    <th>대표이미지</th>
            ...
            <script>
            	...
            	function loadImg(inputFile, num) {
            		...
            		// inputFile : 현재 변화가 생긴 input type = "file"인 요소객체
            		// num : 몇번째 input 요소인지 확인 후 해당 영역에 미리보기 하기 위해 전달 받는 숫자
